'''
A partir de datos validados en transformar.py
crea un archivo JSON que puede ser utilizado
como "fixture" para llenar la base de datos
del app "rutas" con datos del tipo GTFS.
